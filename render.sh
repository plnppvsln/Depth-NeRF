...
python run_nerf.py --config configs/ddpnerf.txt --expname fern_2v_ddp --datadir ./data/nerf_llff_data/fern_2v --render_only --render_factor 2
python run_nerf.py --config configs/ddpnerf.txt --expname fern_3v_ddp --datadir ./data/nerf_llff_data/fern_3v --render_only --render_factor 2
python run_nerf.py --config configs/ddpnerf.txt --expname fern_5v_ddp --datadir ./data/nerf_llff_data/fern_5v --render_only --render_factor 2
python run_nerf.py --config configs/ddpnerf.txt --expname fern_9v_ddp --datadir ./data/nerf_llff_data/fern_9v --render_only --render_factor 2